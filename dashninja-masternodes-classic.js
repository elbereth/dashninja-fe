...
$(document).ready(function() {
    ...
    if (dashninjatestnet == 1) {
        ...
        if (typeof dashninjatestnettor !== 'undefined') {
            $('a[name=dashninjatorurl]').attr("href", "http://"+dashninjatestnettor+"/masternodes-classic.html");
            $('span[name=dashninjatordisplay]').show();
        }

        if (typeof dashninjatestneti2p !== 'undefined') {
            $('a[name=dashninjai2purl]').attr("href", "http://" + dashninjatestneti2p + "/masternodes-classic.html");
